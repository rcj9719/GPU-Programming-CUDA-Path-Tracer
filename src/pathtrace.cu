...
//#define DENOISER_BASE_FILTER_SIZE 81
//#define DENOISER_BASE_FILTER_SIZE 289
//#define DENOISER_BASE_FILTER_SIZE 1089
//#define DENOISER_BASE_FILTER_SIZE 4225

using PathTracer::Common::PerformanceTimer;
...
void pathtrace(uchar4* pbo, int frame, int iter) {
	...
	if (iter == 10) {
		timer().endGpuTimer();
		printf("###PATHTRACER#####");
		printElapsedTime(timer().getGpuElapsedTimeForPreviousOperation(), "(std::chrono Measured)");
	}
